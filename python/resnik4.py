...
TAXON_CODES = {"A!haliana","CElegans","DMelanogaster","HSapiens", "MMusculus", "RNorvegicus",
               "SCerevisiae","SPombe"}

TAXON_FILES = {key : "/extra/wayne1/preserve/resnik/taxons/" + key + ".txt" 
...
if __name__ == "__main__":
    ...
    GENE_ONTOLOGY_FILE = "/extra/wayne1/preserve/resnik/go.obo"
    acSourceType = "ncbi"
    parser = initParser()
