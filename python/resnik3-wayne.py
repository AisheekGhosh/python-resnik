...
import sys
sys.path.append('/extra/wayne_scratch0/preserve/resnik/python/fastsemsim-code/fastsemsim/')
...
acDir = "/extra/wayne_scratch0/preserve/resnik/python/"
...
if __name__ == "__main__":
    ...
    GENE_ONTOLOGY_FILE = "/extra/wayne_scratch0/preserve/resnik/python/go.obo"
    ...
    TAXON_CODES = {"AThaliana","CElegans","DMelanogaster","HSapiens", "MMusculus", "RNorvegicus",
                   "SCerevisiae","SPombe"}
    TAXON_FILES = {key : "/extra/wayne_scratch0/preserve/resnik/python/taxons/" + key + ".txt" 
